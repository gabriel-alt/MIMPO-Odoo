...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Estela (formerly Digiflow) as OSE, please make sure you have "
                       ...
                       "Reference: \n"
                       "https://www.odoo.com/documentation/16.0/applications/finance/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
    ...
    def _l10n_pe_edi_get_edi_values(self, invoice):
        ...
        for line_vals in values['invoice_line_vals_list']:
            line = line_vals['line']
            line_vals['price_unit_type_code'] = '01' if not line.currency_id.is_zero(line_vals['price_subtotal_before_discount']) else '02'
