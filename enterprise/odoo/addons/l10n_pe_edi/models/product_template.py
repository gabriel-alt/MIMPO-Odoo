...
class ProductTemplate(models.Model):
    ...
    l10n_pe_withhold_code = fields.Selection(
        selection=[
            ...
            ('038', 'Espectáculos públicos gravados con el IGV'),
            ('039', 'Minerales no metálicos'),
            ('040', 'Bien inmueble gravado con IGV'),
            ('041', 'Plomo'),
            ('042', 'Ladrillos de construcción, bovedillas, cubrevigas y artículos similares, de cerámica'),
            ('043', 'Estructuras mecánicas para la construcción'),
