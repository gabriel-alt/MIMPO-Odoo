...
class FecImportWizard(models.TransientModel):
    ...
    def _generator_fec_account_move(self, rows, cache):
        ...
        for idx, record in enumerate(rows):
            ...
            partner = cache["res.partner.ref"].get(partner_ref) if partner_ref else False
            partner = partner or cache["res.partner"].get(partner_name) if partner_name else False
