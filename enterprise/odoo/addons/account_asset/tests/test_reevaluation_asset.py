...
class TestAccountAssetReevaluation(AccountTestInvoicingCommon):
    ...
    def test_asset_modify_value_residual_after_reversal(self):
        ...
        asset = self.create_asset(value=1000, periodicity="yearly", periods=5, method="linear", acquisition_date="2020-01-01", prorata="constant_periods", asset_type='expense')
        asset.validate()
    ...
    def test_disposal_of_fully_depreciated_asset(self):
        asset = self.create_asset(value=10000, periodicity="yearly", periods=2, method="degressive", acquisition_date="2020-01-01", prorata="constant_periods")
        asset.validate()
    ...
    def test_asset_disposal_in_middle_of_fiscal_year(self):
        ...
        asset = self.create_asset(value=10000, periodicity="monthly", periods=12, method="degressive", acquisition_date="2022-01-01", prorata="daily_computation")
        asset.validate()
