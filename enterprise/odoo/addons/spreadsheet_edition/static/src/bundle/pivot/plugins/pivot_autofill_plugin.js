        ...
        if (isColumn) {
            ...
            if (nextRowIndex >= groupLevels + 1) {
                ...
                if (currentColIndex >= 0) {
                    cols = table.getCellFromMeasureRowAtIndex(currentColIndex).values;
                    ...
                    cols = [
                        ...currentElement.cols,
                        ...table
                            .getCellFromMeasureRowAtIndex(0)
                            .values.slice(currentElement.cols.length),
                    ];
                }
                ...
                let groupValues;
                if (currentColIndex >= 0) {
                    groupValues = table.getNextColCell(currentColIndex, nextRowIndex).values;
                } else if (groupLevels > 1) {
                    return "";
                } else {
                    // Autofilling value not present in the original table
