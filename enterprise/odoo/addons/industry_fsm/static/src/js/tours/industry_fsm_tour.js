...
const actionDropdownStep = [{
    trigger: ".o_statusbar_buttons .o-dropdown button:contains(Action)",
...
tour.register('industry_fsm_tour', {
    ...
    mobile: true,
    run: (actions) => {
        actions.click(".o_form_view .o_task_customer_field input");
    },
}, {
...
}, ...actionDropdownStep,
{
    ...
    Markup(_t("Use the breadcrumbs to return to your <b>task</b>.")),
    undefined
), ...actionDropdownStep,
{
