...
class DeliveryCarrier(models.Model):
    ...
    sendcloud_shipping_id = fields.Many2one('sendcloud.shipping.product', string="Sendcloud Shipping Product", copy=False)
    sendcloud_return_id = fields.Many2one('sendcloud.shipping.product', string="Sendcloud Return Shipping Product", copy=False)
    ...
    def action_load_sendcloud_shipping_products(self):
        ...
        sendcloud = SendCloud(self.sudo().sendcloud_public_key, self.sudo().sendcloud_secret_key, self.log_xml)
