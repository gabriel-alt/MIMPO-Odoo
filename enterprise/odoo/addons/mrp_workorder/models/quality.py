    ...
    def _next(self, continue_production=False):
        ...
        if float_compare(self.workorder_id.qty_producing, 0, precision_rounding=rounding) <= 0:
            ...
            if self.move_line_id:
                ...
                if float_compare(self.qty_done, self.move_line_id.reserved_uom_qty, precision_rounding=rounding) >= 0:
                ...
                elif float_compare(self.qty_done, self.component_remaining_qty, precision_rounding=rounding) <= 0:
                    ...
                    self.move_line_id.with_context(bypass_reservation_update=True).qty_done = self.qty_done
            else:
