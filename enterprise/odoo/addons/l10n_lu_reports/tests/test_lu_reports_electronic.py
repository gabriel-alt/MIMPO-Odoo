...
class LuxembourgElectronicReportTest(TestAccountReportsCommon):
    ...
    def test_generate_xml(self):
        ...
        sme_is_used = any([value.value for value in self.env['account.report.external.value'].search([('target_report_expression_id', 'in', sme_lines.ids)])])
        expected_xml = """
        ...
        """ % (
            ...
            hasattr(self.env['res.config.settings'], "l10n_eu_oss_eu_country") and '1' or '0',
            hasattr(self.env.company, "ioss") and self.env.company.ioss and '1' or '0',
            sme_is_used and '1' or '0',
        )
