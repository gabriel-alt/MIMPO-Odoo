...
class L10nLuYearlyTaxReportManual(models.Model):
    ...
    # OUTDATED C. Kept for stable policy purposes. Supplies carried out within the scope of the special arrangement of art. 56sexies
    ...
    # C. Total entry of stock for business purposes (all amounts VAT excluded) (12)
    ...
    # D. Stock / Miscellaneous (amounts VAT excluded)
    ...
    @api.depends(
        ...
        "report_section_379", "report_section_386", "report_section_388", "report_section_167", "report_section_180",
        ...
        "report_section_171", "report_section_175", "report_section_201", "report_section_106", "report_section_107",
    )
