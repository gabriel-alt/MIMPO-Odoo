...
with file_open('l10n_mx/data/account.group.template.csv') as group_template_csv:
    reader = csv.reader(group_template_csv, delimiter=',', quotechar='"')
    SAT_GROUPS_CODES = {row[3] for row in reader}
...
class AccountAccount(models.Model):
    ...
    def _compute_l10n_mx_is_sat_invalid(self):
        ...
        incorrect_accounts = self.filtered(
            lambda a: a.code and a.company_id.country_code == 'MX'
