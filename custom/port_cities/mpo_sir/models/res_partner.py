...
class ResPartner(models.Model):
    ...
    def write(self, vals):
        ...
        #(08/01/2025) --> Disabled because SIR reference update endpoint don't work with this code
        #                 and Client request (08/01/2025 Teams reunion) disable this validation on write method.
