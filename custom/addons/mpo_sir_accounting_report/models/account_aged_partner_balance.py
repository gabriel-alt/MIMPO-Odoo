...
class AgedPartnerBalanceCustomHandler(models.AbstractModel):
    ...
    def _custom_options_initializer(self, report, options, previous_options=None):
        super(AgedPartnerBalanceCustomHandler, self)._custom_options_initializer(
    ...
    def _aged_partner_report_custom_engine_common(self, options, internal_type, current_groupby, next_groupby, offset=0, limit=None):
        ...
        def build_result_dict(report, query_res_lines):
            ...
            if current_groupby == 'id':
                ...
                rslt.update({
                    'sir_id': query_res['sir_id'][0] if len(query_res['sir_id']) == 1 else None,
        ...
        query = f"""
            ...
            SELECT
                ...
                ARRAY_AGG(DISTINCT COALESCE(sir.number, sirh.number)) AS sir_id,
            ...
            LEFT JOIN sir_ref sirh ON sirh.id = am.sir_id
            LEFT JOIN LATERAL (
                SELECT
